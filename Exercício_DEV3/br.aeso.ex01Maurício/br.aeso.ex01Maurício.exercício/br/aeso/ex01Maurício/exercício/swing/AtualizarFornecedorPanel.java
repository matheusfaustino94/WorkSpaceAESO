			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					JOptionPane.showMessageDialog(null,
							"Você atualizou o fornecedor com CPF:"+cpf+" com sucesso!",
		...
		btnProcurar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (fornecedorEncontrado != null) {
					...
					ruaFornecedor.setText(fornecedorEncontrado.getEndereço().getRua());
					numeroFornecedor.setText(fornecedorEncontrado.getEndereço().getNumero());
					complementoFornecedor.setText(fornecedorEncontrado.getEndereço().getComplemento());
					bairroFornecedor.setText(fornecedorEncontrado.getEndereço().getBairro());
					cidadeFornecedor.setText(fornecedorEncontrado.getEndereço().getCidade());
					cepFornecedor.setText(fornecedorEncontrado.getEndereço().getCep());
				} else {
